...
?>
     ...
     $qs = mysqli_query($conn,"SELECT * FROM `tblusers` WHERE `role`= 1");
     ...
     $qu = mysqli_query($conn,"UPDATE `tblusers` SET `name`='$_POST[name]',`contact`='$_POST[contact]',`password`= '$password' WHERE id='$_SESSION[id]' AND `role`=1");
     if($qu){
