...
?>
     ...
     $qs = mysqli_query($conn,"SELECT * FROM `tblusers` WHERE `id`='$_SESSION[id]'");
    ...
    $password = md5(mysqli_real_escape_string($conn, $_POST['password']));    
     $qu = mysqli_query($conn,"UPDATE `tblusers` SET `name`='$_POST[name]',`contact`='$_POST[contact]',`password`= '$password' WHERE id='$_SESSION[id]'");
     if($qu){
